...
public class NumberToWord{//Must explicitly declare it as public to import
	public class numberFragment{
		...
		public numberFragment(short in, int i, int _i){
			...
			if(i>=0)this.wordArr[3]=i!=_i-1?core.extendedNumbers(this.exponent):"";
		}
	...
	public class word{
		...
		private void core(String stringIn){
			...
			if(!split[0].matches("0|^$")){//if i-part exists
				String[] ipart=core.altSplit(split[0]);//Split number by 3 places (standard) 
	 ...
	 */
	static final public String word(double in, NumberToWord x){
		double mod=in%1;
	 ...
	 * @return Written out word
	 */
	static final public String word(long in, NumberToWord x){
	...
	public static final void main(String[] iESA){
		...
		NumberToWord x=new NumberToWord();
		while(true){
